...
<iframe id="nyugan-flow" src="/design/nyugan-treatment-flow.html" width="100%" height="800" frameborder="0" style="border-radius:8px; display:block;" scrolling="no"></iframe>
<script>
window.addEventListener('message', function(e) {
  if (e.data && e.data.type === 'iframeResize') {
    document.getElementById('nyugan-flow').style.height = (e.data.height + 20) + 'px';
  }
});
</script>
</div>
<div class="infographic-mobile">
<a href="/design/nyugan-treatment-flow.html" target="_blank" style="display:block; background-color:#FFF0F5; border:1px solid #F0A8BF; border-radius:10px; padding:20px; text-align:center; text-decoration:none; color:#B5446E; font-weight:bold; font-size:1.1em;">
🎗️ 乳がん治療の流れを見る<br><span style="font-size:0.8em; font-weight:normal;">（タップして別画面で開く）</span>
</a>
</div>
